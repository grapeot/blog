...
由于构建观测工具的成本远高于问题本身的价值，我们负担不起获取高解析度观测的代价。 于是，我们被迫发展出一套妥协的生存策略：压缩现实。
...
但在未来，我们更多交付的将是一种[生成内核（Generative Kernel）](/ai-software-engineering.html)。我们将核心的业务逻辑、数据结构和最佳实践封装起来，作为地基。在这个地基之上，AI 可以根据用户具体的、临时的、甚至是一次性的需求，随时生成各种形态的接口和工具。
