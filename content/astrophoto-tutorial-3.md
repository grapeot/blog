...
这篇文章主要介绍深空摄影器材中非常核心的一个部分，相机。请注意，这篇文章包含了我的很多主观看法，所以请大家谨慎鉴别，带着批判的观点去看待。

## 信噪比

相机在深空摄影器材中的作用主要是进行光电转换，把望远镜收集到的光子转化成电子，这样才能方便我们进行后期处理。

相机的一个核心指标是噪点，但严格来说，噪点取决于信号强度和噪声强度。一般来说，大家并不仅仅关注噪声本身的绝对素质，而是更关注信号和噪声之间的比值，也就是信噪比。信噪比越高，图像看起来就更干净。
