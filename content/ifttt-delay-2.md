...
Summary: The IFTTT delay API now supports passing extra POST parameters (Value1, Value2, Value3), enabling more complex automation recipes like delayed blog cross-posting and smart home scene scheduling.
